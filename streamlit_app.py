...
if st.session_state.show_rules:
    st.write('このことわざバトルは、ガチャを引いて出たことわざの意味からそのことわざを当てて敵を倒すゲームです。')
    st.write('レアリティが高くなるほどことわざの難易度が難しくなりますが敵に与えるダメージも多くなります。')
    st.write('問題を正解するとノーマルガチャは0から25ダメージ、レアガチャは20から45ダメージ、スーパーレアガチャは40から55ダメージ敵に与えます。あなたの体力は正解不正解に関わらず、10から25ダメージを負います。')
    st.write('回復ガチャを引き、クイズに正解すると10から20回復しますが、クイズに不正解すると大ダメージを負ってしまいます。(問題の難易度は一番簡単です)')
    st.write('あなたの体力がなくなる前に敵の体力を0にすれば勝ちです。それでは頑張ってください！')
